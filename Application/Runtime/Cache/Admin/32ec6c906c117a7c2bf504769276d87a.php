    ...
    <div class="cont_centrar">
        <div class="cont_login">
            <div class="cont_info_log_sign_up">
                <div class="col_md_login">
                    <div class="cont_ba_opcitiy">
                        ...
                        <button class="btn_login" onClick="cambiar_login()" type="button">LOGIN</button>
                    </div>
                </div>
            ...
            <div class="cont_back_info">
                <div class="cont_img_back_grey"><img src="/Public/po.jpg" alt=""/></div>
            </div>
            <div class="cont_forms">
                <div class="cont_img_back_"><img src="/Public/po.jpg" alt=""/></div>
