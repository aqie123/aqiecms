    ...
    <div class="row">
        ...
        <div class="col-md-10">
            <div class="page-header">
                <ol class="breadcrumb">
                    <li><a href="/admin.php?c=position">推荐位管理</a></li>
            ...
            <form id="singcms-form">
                <div class="form-group">
                    <label for="title">推荐位名称</label>
                    <input type="text" name="name" id="title" class="form-control">
                </div>
                <div class="form-group">
                    <label for="pdesc">推荐位描述</label>
                    <input type="text" name="description" id="pdesc" class="form-control">
                </div>
                <br>
